    ...
    def list_stack_instances(self, stack_set_name):
        try:
            ...
            self.module.fail_json_aws(
                err,
                msg="Error listing stack instances for stackset {0} in account {1}".format(stack_set_name, account_id)
            )
...
def main():
    ...
    for stack_description in service_mgr.describe_stack_sets(module.params.get('stack_set_name')):
        ...
        result['cloudformation'][stack_set_name] = camel_dict_to_snake_dict(facts, ignore_list=('stack_outputs',
                                                                                            'stack_parameters',
                                                                                            'stack_policy',
                                                                                            'stack_resources',
                                                                                            'stack_tags',
